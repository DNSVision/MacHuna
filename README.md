...
| `.EIF` files only | EIF source | Kahuna SWS, Kayenne TGA, Sony TGA, Kayenne EIF |
| Mix of `.EIF` and `.SWS` files | EIF+SWS mixed source | Kahuna SWS, Kayenne TGA, Sony TGA, Kayenne EIF |
